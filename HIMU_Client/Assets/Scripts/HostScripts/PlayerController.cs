...
public class PlayerController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Evita que el personaje vuelque por las físicas; la rotación en Y la controlamos a mano
        rb.constraints = RigidbodyConstraints.FreezeRotationX | RigidbodyConstraints.FreezeRotationZ;
        rb.interpolation = RigidbodyInterpolation.Interpolate; // movimiento más suave
    }
